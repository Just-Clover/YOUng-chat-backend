...
//        String saveChatId = (String) ReflectionTestUtils.getField(chat, "id");
//
//        // when
...
//        assertThat(foundChat.get().getSenderId()).isEqualTo(user.getId());
//        assertThat(foundChat.get().getChatRoomId()).isEqualTo(chatRoom.getId());
//    }
//
//    @Test
